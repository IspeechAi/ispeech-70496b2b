...
interface TargetVoiceSelectorProps {
  selectedTargetVoice: string;
  onVoiceChange: (voiceId: string) => void;
  myVoices: VoiceClone[];
}

const TargetVoiceSelector = ({ selectedTargetVoice, onVoiceChange, myVoices }: TargetVoiceSelectorProps) => {
  ...
  return (
    <div>
      ...
      <Select value={selectedTargetVoice} onValueChange={onVoiceChange}>
...
export default TargetVoiceSelector;
